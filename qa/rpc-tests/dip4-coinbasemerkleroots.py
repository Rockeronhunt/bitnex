...
from test_framework.test_framework import BITNEXTestFramework
...
class LLMQCoinbaseCommitmentsTest(BITNEXTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BITNEXTestFramework doesn't support this atm)
