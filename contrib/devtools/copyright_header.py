...
Arguments:
    <base_directory> - The base directory of a BITNEX Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BITNEX Core developers'
...
Arguments:
    <base_directory> - The base directory of BITNEX Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BITNEX Core repository.
"""
