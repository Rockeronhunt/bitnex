...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner BITNEX address\n"
            "  payee          - Print the masternode payout BITNEX address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting BITNEX address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitnex",               "masternode",             &masternode,             true,  {} },
    { "bitnex",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitnex",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "bitnex",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
