...
#define BOOST_TEST_MODULE BITNEX Test Suite

#include "test_bitnex.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitnex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
