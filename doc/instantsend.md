...
This mechanism has been integrated into Bitcore-Node-BITNEX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitnexpay/insight-api-bitnex#web-socket-api](https://github.com/bitnexpay/insight-api-bitnex#web-socket-api)
* API: [https://github.com/bitnexpay/insight-api-bitnex#instantsend-transactions](https://github.com/bitnexpay/insight-api-bitnex#instantsend-transactions)
