...
* bitnex.conf: contains configuration settings for bitnexd or bitnex-qt
* bitnexd.pid: stores the process id of bitnexd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by bitnexd or bitnex-qt
